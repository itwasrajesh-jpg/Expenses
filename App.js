...
function AppInner() {
  ...
  if (locked) {
    return (
      <View style={{ flex: 1 }}>
        ...
        <LockScreen pin={state.pin} biometric={state.biometric} bioType={bioType} onUnlock={() => setLocked(false)} T={T} />
      </View>
    );
  }
  ...
  return (
    <View style={[styles.root, { backgroundColor: T.bg }]}>
      ...
      {showVoiceListen && <VoiceListenOverlay T={T} animLevel={aL} onClose={() => setShowVoiceListen(false)} onAdd={payload => { dispatch({ type:'ADD', payload }); setShowVoiceListen(false); }} userKeywords={state.voiceKeywords||[]} />}
