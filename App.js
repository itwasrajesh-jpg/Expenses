    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ position: 'relative', height: FIELD_H }}>
          {/* ── Voice mic bubble — only shows when voiceEnabled ── */}
          {state.voiceEnabled && <Animated.View style={{
            position:'absolute', bottom:-50, right:8,
            width:58, height:58, borderRadius:29,
            backgroundColor: T.accent+'22',
            borderWidth:1.5, borderColor: T.accent+'80',
            alignItems:'center', justifyContent:'center',
            zIndex:50,
            shadowColor: T.accent, shadowOpacity:0.6, shadowRadius:12, elevation:8,
            ...
            <Animated.View style={{
              ...
              transform:[{ scale: breathAnim
                ? breathAnim.interpolate({ inputRange:[0,1], outputRange:[1,1.25] })
                : 1 }],
            }} pointerEvents="none" />
            <TouchableOpacity
              onPress={onVoiceTap}
              style={{ width:'100%', height:'100%', borderRadius:29, alignItems:'center', justifyContent:'center', gap:2 }}
              activeOpacity={0.8}>
  ...
  return (
    <View style={{ flex:1, backgroundColor:T.bg }}>
      <View style={{ flexDirection:'row', alignItems:'center', padding:20, paddingBottom:12 }}>
        <TouchableOpacity onPress={onClose} style={{ marginRight:12, width:36, height:36,
          borderRadius:12, backgroundColor:T.surface2, alignItems:'center', justifyContent:'center' }}>
          <Text style={{ color:T.text, fontSize:18 }}>←</Text>
        </TouchableOpacity>
        <Text style={{ color:T.text, fontSize:20, fontWeight:'800' }}>🎙️ Voice Quick Add</Text>
      </View>
      ...
      <ScrollView style={{ flex:1 }} contentContainerStyle={{ padding:16 }}
        ...
        <Section id="commands" title="Example voice commands" icon="🗣️">
          {[
            ['Auto fare', 'Transport', '₹200', '"Auto 200 transport"'],
            ['Zomato order', 'Food', '₹450', '"Zomato food 450 rupees"'],
            ['Beer', 'Entertainment', '₹500', '"Beer entertainment 500"'],
            ['Netflix', 'Subscriptions', '₹649', '"Netflix subscriptions 649"'],
            ['Groceries', 'Groceries', '₹800', '"Grocery 800 bigbasket"'],
          ].map(([name, cat, amt, cmd], i) => (
            <View key={i} style={{ backgroundColor:T.surface2, borderRadius:10,
              padding:10, marginBottom:8 }}>
              <Text style={{ color:T.accent, fontSize:12, fontWeight:'700', marginBottom:4 }}>
                Say: {cmd}
              </Text>
          ...
          <Text style={{ color:T.sub, fontSize:11, marginTop:4, lineHeight:18 }}>
            Tip: You can say the amount, category and name in any order. The app will figure it out.
          </Text>
        </Section>
