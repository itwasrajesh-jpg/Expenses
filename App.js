        ...
        <Animated.View key={cat.name} ref={refs[i].wrap}
          ...
          <TouchableOpacity onPress={() => onSelect(i)} activeOpacity={0.9}
            ...
            <View ref={refs[i].circ}
              ...
              {/* Subtle colour wash for white/dark — no extra ring layer */}
              {(T.white || T.dark) && (
                <View style={{ position:'absolute', top:0, left:0, right:0, bottom:0, borderRadius:bSize/2,
                  backgroundColor: cat.color + (T.white ? '12' : '0E') }} />
              )}
