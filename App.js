...
const THEMES = {
  ...
  white: {
    ...
    grad1: '#FF5533', grad2: '#FF3D1F', nav: '#ECEEF3', card: '#FF5533',
    white: true,
  },
  dark: {
        ...
        <Animated.View key={cat.name} ref={refs[i].wrap}
          ...
          <TouchableOpacity onPress={() => onSelect(i)} activeOpacity={0.9}
            ...
            <View ref={refs[i].circ}
              ...
              {/* White theme: coloured inner ring */}
              {T.white && <View style={{ position:'absolute', top: bSize*0.07, left: bSize*0.07, right: bSize*0.07, bottom: bSize*0.07, borderRadius: bSize/2, backgroundColor: cat.color + '18', borderWidth: 1.5, borderColor: cat.color + '33' }} />}
              {/* Shine */}
              <View style={{ position: 'absolute', top: '10%', left: '14%', width: '28%', height: '18%', borderRadius: 99, backgroundColor: T.white ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.25)' }} />
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View style={[{ marginHorizontal: 16, marginBottom: 12 }, aS(cardAnim)]}>
          ...
          <View style={T.glass ? {
            ...
            {/* Default theme: use original card style */}
            {!T.glass && <View style={{ position:'absolute', top:0, left:0, right:0, bottom:0,
            ...
            <View style={{ position:'relative', zIndex:1, padding: T.glass ? 20 : 0 }}>
              ...
              <CountUp value={spent} style={[styles.cardAmt, T.glass && { textShadowColor:'rgba(185,133,250,0.4)', textShadowRadius:12 }]} />
              <View style={styles.cardRow}>
                {[['Budget', state.budget], ['Remaining', Math.max(state.budget - spent, 0)]].map(([l, v]) => (
                  <View key={l} style={[styles.cardPill,
                    ...
                    (T.white||T.dark) && { backgroundColor:'rgba(255,255,255,0.15)', borderWidth:1, borderColor:'rgba(255,255,255,0.12)' },
                  ]}>
