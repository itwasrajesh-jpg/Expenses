...
function ConstellationStar({ ins, index, onPress, animLevel }) {
  ...
  const sz  = isHero ? 52 : isMid ? 40 : 30;
  const fs  = isHero ? 24 : isMid ? 18 : 14;
  const gsz = sz * 2.4;
...
function SavedInsightsView({ savedInsights, dispatch, T, animLevel }) {
  ...
  // Layout positions for stars — fixed grid, different per count
  const LAYOUTS = {
    1:[[0.5,0.38]],
    2:[[0.28,0.32],[0.72,0.52]],
    3:[[0.5,0.2],[0.2,0.58],[0.78,0.55]],
    4:[[0.5,0.18],[0.18,0.5],[0.8,0.44],[0.46,0.72]],
    5:[[0.5,0.16],[0.16,0.44],[0.82,0.38],[0.26,0.7],[0.72,0.66]],
    6:[[0.5,0.16],[0.16,0.4],[0.82,0.36],[0.26,0.68],[0.72,0.63],[0.5,0.5]],
    7:[[0.5,0.14],[0.14,0.38],[0.82,0.33],[0.2,0.66],[0.72,0.63],[0.46,0.5],[0.54,0.76]],
    8:[[0.5,0.13],[0.13,0.36],[0.84,0.3],[0.18,0.63],[0.74,0.6],[0.44,0.48],[0.5,0.74],[0.76,0.76]],
  };
