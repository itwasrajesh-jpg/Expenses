...
function tileStyle(T, extra = {}) {
  ...
  if (T.white) return {
    ...
    borderBottomColor: 'rgba(166,172,189,0.55)',
    borderRightColor: 'rgba(166,172,189,0.45)',
    shadowColor: '#A6ACBD',
    shadowOpacity: 0.5,
    shadowRadius: 8,
  ...
  return (
    <TouchableOpacity onPress={() => onPress(expense)}
      ...
      <Animated.View style={[styles.row, { backgroundColor: T.surface, transform: [{ scale }, { translateX: tx }], opacity: op }]}>
        <View style={[styles.rowIcon, T.white ? { backgroundColor:'#ECEEF3', borderTopWidth:1, borderLeftWidth:1, borderTopColor:'rgba(255,255,255,0.95)', borderLeftColor:'rgba(255,255,255,0.85)', borderBottomWidth:1, borderRightWidth:1, borderBottomColor:'rgba(166,172,189,0.5)', borderRightColor:'rgba(166,172,189,0.4)', elevation:3 } : T.matte ? { backgroundColor:'#1A1A1A', borderTopWidth:1, borderLeftWidth:1, borderTopColor:'rgba(255,255,255,0.08)', borderLeftColor:'rgba(255,255,255,0.05)', borderBottomWidth:1, borderRightWidth:1, borderBottomColor:'rgba(0,0,0,0.85)', borderRightColor:'rgba(0,0,0,0.7)', elevation:4 } : { backgroundColor: cat.color + '28' }]}>
...
export default function App() {
  ...
  const T = (state.theme === 'default' || state.theme === 'amoled')
    ...
    : {
        ...
        grad2:  _ap.grad2,
        card: T_base.white
          ? _ap.grad1          // white magic: spend card uses grad1
          : T_base.matte
          ? _ap.card           // matte: deep dark card tinted with accent colour
          : T_base.dark
          ? _ap.card           // amoled magic: same
          : _ap.card,
      };
