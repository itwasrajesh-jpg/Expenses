...
// ─── STATS SCREEN ─────────────────────────────────────────────────────────────
function StatsScreen({ expenses, featEntries, bills, dispatch, T, animLevel, selCat, setSelCat, onEditExpense }) {
...
export default function App() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: T.bg }]}>
      ...
      {tab === 'stats'    && <StatsScreen    expenses={state.expenses} featEntries={state.featEntries} bills={state.bills||[]} dispatch={dispatch} T={T} animLevel={aL} selCat={statsCat} setSelCat={setStatsCat} onEditExpense={e => { setFormEx(e); setShowForm(true); }} />}
      ...
      {showSubscriptions && (
        <View style={{ position:'absolute', top:0, left:0, right:0, bottom:0, backgroundColor: T.bg, zIndex:80 }}>
          ...
          <TouchableOpacity onPress={() => setShowSubscriptions(false)}
            style={{ position:'absolute', top:52, left:16, width:36, height:36, borderRadius:18, backgroundColor:'rgba(255,255,255,0.08)', alignItems:'center', justifyContent:'center' }}>
            <Text style={{ color: T.text, fontSize:18 }}>←</Text>
          </TouchableOpacity>
        </View>
      )}
      {showTaxSummary && (
        <View style={{ position:'absolute', top:0, left:0, right:0, bottom:0, backgroundColor: T.bg, zIndex:80 }}>
          ...
          <TouchableOpacity onPress={() => setShowTaxSummary(false)}
            style={{ position:'absolute', top:52, left:16, width:36, height:36, borderRadius:18, backgroundColor:'rgba(255,255,255,0.08)', alignItems:'center', justifyContent:'center' }}>
            <Text style={{ color: T.text, fontSize:18 }}>←</Text>
          </TouchableOpacity>
        </View>
