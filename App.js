...
function MoreScreen({ features, featEntries, dispatch, expenses, T, animLevel, collapsed, setCollapsed }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {/* Cat animation — bottom of More tab */}
      <View style={{ alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 4 }} pointerEvents="none">
        <LottieView
...
export default function App() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: T.bg }]}>
      <StatusBar barStyle="light-content" backgroundColor={T.bg} />
      {tab === 'home' && <HomeScreen state={state} dispatch={dispatch} onRow={handleRow} onEdit={handleEdit} onQuickAdd={() => { setFormEx(null); setShowForm(true); }} T={T} animLevel={aL} collapsed={homeCollapsed} setCollapsed={setHomeCollapsed} onSaveInsights={handleSaveInsights} />}
